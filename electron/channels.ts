export const CH = {
  ...
  storageGet: 'pos:storage:get',
  storageSet: 'pos:storage:set',
  storageRemove: 'pos:storage:remove',
  ...
  printOrder: 'pos:print:order',
  printListUsb: 'pos:print:list-usb',
  printTestConfig: 'pos:print:test-config',
